...
// Mesmo texto usado no backend para gerar o PDF do Termo de Responsabilidade
const TEXTO_TERMO = [
...
async function carregarFicha() {
  ...
  try {
    ...
    if (ficha.status === 'Assinada') {
      document.getElementById('carregando').textContent = '✅ Este documento já foi assinado anteriormente. Nada a fazer.';
      return;
    }
